...
namespace DBA.DAL
{
    ...
    public partial class Achievement
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from Achievement");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Achievement(");
            strSql.Append("UserID,CourseID,TeacherID,Score,Time)");
            strSql.Append(" values (");
            strSql.Append("@UserID,@CourseID,@TeacherID,@Score,@Time)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@UserID", SqlDbType.NVarChar,50),
					new SqlParameter("@CourseID", SqlDbType.NVarChar,50),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Achievement set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Achievement ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        public DBA.Model.Achievement GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,UserID,CourseID,TeacherID,Score,Time from Achievement ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public DBA.Model.Achievement DataRowToModel(DataRow row)
        {
            DBA.Model.Achievement model = new DBA.Model.Achievement();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,UserID,CourseID,TeacherID,Score,Time ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,UserID,CourseID,TeacherID,Score,Time ");
            strSql.Append(" FROM Achievement ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Achievement T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "Achievement";
